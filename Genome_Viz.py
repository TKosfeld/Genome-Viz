...
#Dash Bio Implementation
values = visual.values
#print(values)
app.layout = html.Div(
        [dcc.Graph(figure=dashbio.Clustergram(data = values, column_labels = ['Cohort 1','Cohort 2'], row_labels = list(visual.index), center_values = False, height=1200, width = 1500, color_map= [
            [0.0, '#f54842'],
            [0.05, '#f5a742'],
            [0.1, '#f5dd42'],
            [0.15, '#aaf542'],
